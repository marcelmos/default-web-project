    ...
    return(
        <nav className="sticky top-0 max-h-[90px] px-11 py-4 bg-coal-600 text-xl bg-opacity-75 z-50 flex items-center">
            <ul className="flex justify-center font-light">
                ...
                <li className="px-4 mx-2"><a href="#">Projects</a></li>
                <li className="px-4 mx-2"><a href="#">FAQ</a></li>
                <li className="px-4 mx-2"><a href="#">About Me</a></li>
                <li className="px-4 mx-2"><a href="#">Contact</a></li>
            </ul>
