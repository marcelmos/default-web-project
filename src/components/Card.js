...
export default function Card(){
    ...
    return(
        <div className="py-7 px-8 bg-coal-400 rounded-2xl w-full max-w-400">
            ...
            <a href="" className="bg-yellow-400 hover:bg-yellow-500 max-w-fit text-coal-500 text-xl mt-10 ml-auto mr-0 px-6 py-4 max-h-15 rounded-full font-bold flex justify-around items-center whitespace-nowrap">Check out project <ArrowRightIcon className='w-8 ml-3' /></a>
        </div>
    );
}