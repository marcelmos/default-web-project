...
export default function Footer( props ){
    ...
    return(
        <footer className="bg-coal-700">
            <div className="grid grid-cols-3 md:grid-cols-4 gap-5 px5 md:px-32 py-11">
                <div className="">
                ...
                <div className="flex flex-col justify-between">
                    <ul>
                        <li className="">
                            <a href="https://www.linkedin.com/in/marcel-moś-a171981a8/" target="_blank" rel="noreferrer" className="flex">
